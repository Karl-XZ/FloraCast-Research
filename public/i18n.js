...
const I18n = {
  ...
  translations: {
    en: {
      ...
      // Brand
      'brand.tag': '3D Phenology Monitor',

      // Layers & Base Maps
      'layers.title': 'Layers & Base Maps',
      ...
      'layers.compare_label': 'Dual-map Compare',
      'layers.compare_enable': 'Enable Compare',
      'layers.compare_disable': 'Disable Compare',
      'layers.compare_desc': 'When enabled, the globe is split left/right for comparison. Each side can be configured independently.',
      'layers.split_pos_label': 'Compare · Split Position',
      'layers.divider_label': 'Divider:',
      'layers.mapa_rs_overlay': 'Map A · Remote Sensing Overlay',
      'layers.opt_no_sat': 'Gaode/Amap Base Map (no satellite overlay)',
      'layers.opt_viirs_snpp': 'VIIRS SNPP True Color (Daily, from 2015.11.24)',
      'layers.opt_viirs_noaa20': 'VIIRS NOAA-20 True Color (Daily, from 2018.01.05)',
      'layers.opt_modis_terra': 'MODIS Terra True Color (Daily, from 2000.02.24)',
      'layers.opt_modis_aqua': 'MODIS Aqua True Color (Daily, from 2002.07.03)',
      'layers.mapa_year': 'Map A · Year',
      'layers.mapa_date': 'Map A · Date',
      'layers.mapa_opacity': 'Map A · Overlay Opacity',
      'layers.mapa_opg': 'Map A · OpenPortGuide (overlay)',
      'layers.btn_add_mapa': 'Add to Map A',
      'layers.btn_remove': 'Remove',
      'layers.btn_copy_tile_url': 'Copy Tile URL',
      'layers.opg_hint': 'GFS Numerical Forecast (0h~72h). Data: OpenPortGuide (CC BY-NC-SA 4.0)',
      'layers.mapa_gibs': 'Map A · NASA GIBS — WMS (overlay)',
      'layers.gibs_modis_terra_ndvi': 'MODIS Terra NDVI 16Day (from 2000.03.05)',
      'layers.gibs_modis_terra_evi': 'MODIS Terra EVI 16Day (from 2000.03.05)',
      'layers.gibs_modis_aqua_ndvi': 'MODIS Aqua NDVI 16Day (from 2002.07.04)',
      'layers.gibs_modis_aqua_evi': 'MODIS Aqua EVI 16Day (from 2002.07.04)',
      'layers.gibs_landsat_ndvi': 'Landsat WELD NDVI Monthly (from 1984.03.01)',
      'layers.gibs_modis_aqua_lst_day': 'MODIS Aqua LST Day (from 2002.07.03)',
      'layers.gibs_modis_terra_lst_night': 'MODIS Terra LST Night (from 2000.02.24)',
      'layers.gibs_viirs_lst_day': 'VIIRS SNPP Land Surface Temp Day (from 2012.01.19)',
      'layers.gibs_viirs_lst_night': 'VIIRS SNPP Land Surface Temp Night (from 2012.01.19)',
      'layers.gibs_viirs_ndvi': 'VIIRS SNPP NDVI 8Day (from 2025.07.01)',
      'layers.gibs_viirs_evi': 'VIIRS SNPP EVI 8Day (from 2025.07.01)',
      'layers.gibs_rainwater': 'Convective Rainwater Source (from 1980.01.01)',
      'layers.btn_copy_getmap': 'Copy GetMap URL',
      'layers.gibs_hint': 'NASA GIBS Remote Sensing Layers (LST, NDVI, True Color, etc.) are indexed daily from real satellite archives.',
      'layers.mapb_rs_overlay': 'Map B · Remote Sensing Overlay',
      'layers.mapb_year': 'Map B · Year',
      'layers.mapb_date': 'Map B · Date',
      'layers.mapb_opacity': 'Map B · Overlay Opacity',
      'layers.mapb_opg': 'Map B · OpenPortGuide (overlay)',
      'layers.btn_add_mapb': 'Add to Map B',
      'layers.mapb_gibs': 'Map B · NASA GIBS — WMS (overlay)',

      // OpenPortGuide
      'opg.wind_stream': 'Wind Streamlines',
      'opg.wind_barb': 'Wind Barbs',
      'opg.gust': 'Wind Gust',
      'opg.surface_pressure': 'Surface Pressure',
      'opg.air_temperature': 'Air Temperature',
      'opg.precipitation': 'Precipitation',
      'opg.precipitation_shaded': 'Precipitation (Shaded)',
      'opg.significant_wave_height': 'Significant Wave Height',
      'opg.primary_wave_height_direction': 'Primary Wave Direction',
      'opg.primary_wave_period': 'Primary Wave Period',

      // Photos Panel
      'photos.title': 'Flower Photos (iNaturalist)',
      'photos.enable': 'Enable',
      'photos.disable': 'Disable',
      'photos.heatmap_mode': 'Heatmap mode',
      'photos.date_range': 'Date range',
      'photos.to': 'to',
      'photos.taxon': 'Taxon',
      'photos.taxon_angio': 'Angiosperms (default)',
      'photos.taxon_all': 'Plantae (all plants)',
      'photos.max_pages': 'Max pages',
      'photos.search_radius': 'Search radius (km, from selected point)',

      // Vegetation Index Panel
      'veg.title': 'Vegetation Index (NDVI/EVI) · Nearby Species · Invasives',
      'veg.product': 'Product',
      'veg.opt_mod13q1': 'MOD13Q1 · MODIS Terra · 16-day (250m)',
      'veg.opt_vnp13a1': 'VNP13A1 · VIIRS SNPP · 16-day (500m)',
      'veg.query_btn': 'Query Latest Composite',
      'veg.query_hint': 'Queries NDVI/EVI at the selected point (latest available date).',
      'veg.th_variable': 'Variable',
      'veg.th_value': 'Value',
      'veg.th_note': 'Note',
      'veg.composite_date': 'Composite date',
      'veg.nearby_species': 'Nearby species (iNaturalist)',
      'veg.load_species': 'Load species (year & radius)',
      'veg.filter_placeholder': 'Filter by common/scientific name…',
      'veg.plot_counts': 'Plot monthly counts',
      'veg.show_map': 'Show selected species on map',
      'veg.clear_markers': 'Clear species markers',
      'veg.counts_note': 'Counts are iNaturalist monthly observations near the selected point for the chosen year.',
      'veg.rain_label': 'Rainfall · Aridity · “Superbloom”',
      'veg.load_power_365': 'Load last 365 days (POWER)',
      'veg.aridity_init': 'Aridity index: —',
      'veg.superbloom_init': 'Superbloom prediction: — (rainfall-based)',
      'veg.pollinator_label': 'Pollinator dynamics (iNat taxa IDs, comma separated)',
      'veg.plot_pollinators': 'Plot pollinator counts',
      'veg.pollinator_hint': 'Default taxa: Lepidoptera (47157), Apoidea (630955). Edit if needed.',
      'veg.invasives_label': 'Invasives (Auto, last 5 years near point)',
      'veg.btn_analyze_topn': 'Analyze top-N species',
      'veg.btn_show_map': 'Show on map',
      'veg.btn_clear': 'Clear',
      'veg.invasives_note': 'Ranks species by 5-year observation counts near the point, flags potential invasives (heuristic or curated list if present).',
      'veg.th_rank': 'Rank',
      'veg.th_common_name': 'Common name',
      'veg.th_scientific': 'Scientific',
      'veg.th_5y_count': '5y Count',
      'veg.th_flag': 'Flag',
      'veg.no_invasives': 'No invasive candidates found.',

      // Phenology Panel
      'pheno.title': 'Phenology & Prediction',
      'pheno.curr_loc': 'Current location',
      'pheno.year_label': 'Year (POWER daily)',
      'pheno.compute_btn': 'Compute Bloom Prediction',
      'pheno.th_flower': 'Flower',
      'pheno.th_base_temp': 'Base Temp (°C)',
      'pheno.th_gdd': 'GDD Threshold',
      'pheno.th_pred_date': 'Predicted Date',
      'pheno.th_days': 'Accumulated Days',
      'pheno.flower_custom': 'Custom',
      'pheno.flower_cherry': 'Cherry Blossom',
      'pheno.flower_tulip': 'Tulip',
      'pheno.flower_jasmine': 'Winter Jasmine',
      'pheno.flower_plum': 'Plum Blossom',
      'pheno.flower_peach': 'Peach Blossom',
      'pheno.flower_rapeseed': 'Rapeseed',
      'pheno.flower_wisteria': 'Wisteria',
      'pheno.flower_rose': 'Rose',
      'pheno.not_reached': 'Not Reached',

      // Weather Panel
      'weather.title': 'Weather (NASA POWER)',
      'weather.query_date': 'Query date',
      'weather.query_btn': 'Query',
      'weather.lag_note': 'POWER data lags by 1–2 days; try querying yesterday or the day before.',

      // Workflow Panel
      'workflow.title': 'GeoAI Workflow',
      'workflow.curr_center': 'Current patch center',
      'workflow.stage1_title': 'Data Sources',
      'workflow.stage1_desc': 'Gaode base map, ORNL MODIS/VIIRS vegetation composites, NASA POWER weather, iNaturalist observations.',
      'workflow.stage2_title': 'Spatial Location',
      'workflow.stage2_desc': 'Map marker coordinate plus radius-defined patch sampling around the selected location.',
      'workflow.stage3_title': 'Remote-Sensing Metrics',
      'workflow.stage3_desc': 'NDVI/EVI time series, recent patch mean, trend, quality-aware latest composite date.',
      'workflow.stage4_title': 'AI/ML Analysis',
      'workflow.stage4_desc': 'Phenology GDD, seasonal trend heuristics, Qwen-compatible assistant, forecast-ready features.',
      'workflow.stage5_title': 'Visual Explanation',
      'workflow.stage5_desc': 'Patch time series, health/risk labels, bloom window, map-linked observations and reports.',
      'workflow.meta_spatial': 'Spatial engine',
      'workflow.meta_rs': 'Remote sensing',
      'workflow.meta_climate': 'Climate driver',
      'workflow.meta_deploy': 'Deployment',
      'workflow.meta_ready': 'ModelScope Space ready',
      'workflow.action_title': 'Run GeoAI Workflow',
      'workflow.action_desc': 'Use the current map marker and radius to execute the full chain: spatial patch → remote-sensing metrics → POWER phenology → health/risk/bloom interpretation.',
      'workflow.radius_label': 'Patch radius (km)',
      'workflow.product_label': 'Vegetation product',
      'workflow.history_label': 'History length (years)',
      'workflow.run_btn': 'Run Full Workflow',
      'workflow.center_btn': 'Use Current Map Center',
      'workflow.status_ready': 'Ready. Select a map point or use the current map center, then run the workflow.',
      'workflow.res_health': 'Vegetation health',
      'workflow.res_risk': 'Phenology risk',
      'workflow.res_window': 'Bloom window',
      'workflow.res_hint': 'Run the workflow to generate evidence-backed patch interpretation.',

      // Patch Analysis Panel
      'patch.title': 'GeoAI Patch Analysis',
      'patch.loc_label': 'Map location',
      'patch.radius_label': 'Patch radius (km)',
      'patch.product_label': 'Vegetation product',
      'patch.history_label': 'History length (years)',
      'patch.run_btn': 'Run Patch Analysis',
      'patch.center_btn': 'Use Current Map Center',
      'patch.res_health': 'Vegetation health',
      'patch.res_risk': 'Phenology risk',
      'patch.res_window': 'Bloom window',
      'patch.hint': 'Run analysis to generate a patch-level interpretation.',

      // AI Assistant Panel
      'ai.title': 'AI Assistant',
      'ai.btn_what_to_plant': 'Analyze: What to plant here?',
      'ai.btn_ask_followup': 'Ask / Follow up',
      'ai.placeholder': 'Type your question (optional)…',

      // Plant ID Panel
      'plantid.title': 'Plant ID (Remote Image Recognition)',
      'plantid.desc': 'Upload a flower/plant photo and get species suggestions through the server-side Qwen-VL compatible proxy. For conservation projects, use this as a first pass and verify with experts or field guides.',
      'plantid.provider_label': 'Provider',
      'plantid.provider_opt': 'Qwen-VL compatible open model endpoint',
      'plantid.region_hint_label': 'Region / habitat hint',
      'plantid.region_hint_placeholder': 'China, East Asia, wetland, alpine meadow, urban park, ...',
      'plantid.organ_label': 'Organ',
      'plantid.organ_auto': 'Auto',
      'plantid.organ_flower': 'Flower',
      'plantid.organ_leaf': 'Leaf',
      'plantid.organ_fruit': 'Fruit',
      'plantid.organ_bark': 'Bark',
      'plantid.image_label': 'Image',
      'plantid.identify_btn': 'Identify',
      'plantid.export_btn': 'Export result (JSON)',

      // Forecast Panel
      'forecast.title': 'NDVI/EVI Forecast (30 days)',
      'forecast.product_label': 'Product',
      'forecast.target_index': 'Target Index',
      'forecast.opt_ndvi': 'NDVI (Normalized Difference Vegetation Index)',
      'forecast.opt_evi': 'EVI (Enhanced Vegetation Index)',
      'forecast.history_len': 'History length (years)',
      'forecast.pull_note': 'We’ll pull ~16-day composites over N years and align with daily POWER weather.',
      'forecast.train_opts': 'Training options',
      'forecast.epochs': 'epochs',
      'forecast.lr': 'learning rate',
      'forecast.tfjs_note': 'If TensorFlow.js is unavailable, a linear baseline fallback will be used.',
      'forecast.btn_train': 'Train + Forecast',
      'forecast.btn_clear': 'Clear',
      'forecast.inputs_desc': 'Inputs: historical NDVI/EVI (MODIS/VIIRS) + daily POWER T2M & Precip; engineered features include lag values & seasonal encodings.',

      // Common
      'common.analyzing': 'Analyzing…',
      'common.analyze_failed': 'Analyze failed.',
    ...
    zh: {
      ...
      // Layers & Base Maps
      'layers.title': '图层与底图',
      'layers.base_map': '底图数据源',
      'layers.opt_amap': '高德矢量底图 (默认)',
      'layers.opt_baidu_vec': '百度矢量底图 (BD-09纠偏)',
      'layers.opt_baidu_sat': '百度卫星影像',
      'layers.opt_tianditu_sat': '天地图全球卫星',
      'layers.opt_osm': 'OpenStreetMap 矢量地图',
      'layers.base_map_hint': '', // Deleted per user request
      'layers.compare_label': '双图对比模式',
      'layers.compare_enable': '开启对比',
      'layers.compare_disable': '关闭对比',
      'layers.compare_desc': '启用后，三维地球将左右分栏对比。两侧可独立配置不同时相和遥感图层。',
      'layers.split_pos_label': '对比 · 卷帘分割线位置',
      'layers.divider_label': '分割比例:',
      'layers.mapa_rs_overlay': '地图 A · 遥感影像图层',
      'layers.opt_no_sat': '高德矢量底图（无卫星叠加）',
      'layers.opt_viirs_snpp': 'VIIRS SNPP 每日真彩色（自 2015.11.24 起）',
      'layers.opt_viirs_noaa20': 'VIIRS NOAA-20 每日真彩色（自 2018.01.05 起）',
      'layers.opt_modis_terra': 'MODIS Terra 每日真彩色（自 2000.02.24 起）',
      'layers.opt_modis_aqua': 'MODIS Aqua 每日真彩色（自 2002.07.03 起）',
      'layers.mapa_year': '地图 A · 年份',
      'layers.mapa_date': '地图 A · 日期',
      'layers.mapa_opacity': '地图 A · 图层不透明度',
      'layers.mapa_opg': '地图 A · OpenPortGuide 海洋气象图层',
      'layers.btn_add_mapa': '添加到地图 A',
      'layers.btn_remove': '移除',
      'layers.btn_copy_tile_url': '复制瓦片 URL',
      'layers.opg_hint': 'GFS 数值预报 (0h~72h)。数据来源: OpenPortGuide (CC BY-NC-SA 4.0)',
      'layers.mapa_gibs': '地图 A · NASA GIBS 科学图层 (WMS)',
      'layers.gibs_modis_terra_ndvi': 'MODIS Terra 植被绿度 NDVI 16日合成（自 2000.03.05 起）',
      'layers.gibs_modis_terra_evi': 'MODIS Terra 增强植被指数 EVI 16日合成（自 2000.03.05 起）',
      'layers.gibs_modis_aqua_ndvi': 'MODIS Aqua 植被绿度 NDVI 16日合成（自 2002.07.04 起）',
      'layers.gibs_modis_aqua_evi': 'MODIS Aqua 增强植被指数 EVI 16日合成（自 2002.07.04 起）',
      'layers.gibs_landsat_ndvi': 'Landsat WELD 月度植被绿度 NDVI（自 1984.03.01 起）',
      'layers.gibs_modis_aqua_lst_day': 'MODIS Aqua 白天地表温度 LST（自 2002.07.03 起）',
      'layers.gibs_modis_terra_lst_night': 'MODIS Terra 夜间地表温度 LST（自 2000.02.24 起）',
      'layers.gibs_viirs_lst_day': 'VIIRS SNPP 白天地表温度（自 2012.01.19 起）',
      'layers.gibs_viirs_lst_night': 'VIIRS SNPP 夜间地表温度（自 2012.01.19 起）',
      'layers.gibs_viirs_ndvi': 'VIIRS SNPP 植被绿度 NDVI 8日合成（自 2025.07.01 起）',
      'layers.gibs_viirs_evi': 'VIIRS SNPP 增强植被指数 EVI 8日合成（自 2025.07.01 起）',
      'layers.gibs_rainwater': '对流降水水汽源（自 1980.01.01 起）',
      'layers.btn_copy_getmap': '复制 GetMap 链接',
      'layers.gibs_hint': 'NASA 遥感图层（地表温度 LST、NDVI、真彩色等）支持按真实卫星归档逐日回溯。',
      'layers.mapb_rs_overlay': '地图 B · 遥感影像图层',
      'layers.mapb_year': '地图 B · 年份',
      'layers.mapb_date': '地图 B · 日期',
      'layers.mapb_opacity': '地图 B · 图层不透明度',
      'layers.mapb_opg': '地图 B · OpenPortGuide 海洋气象图层',
      'layers.btn_add_mapb': '添加到地图 B',
      'layers.mapb_gibs': '地图 B · NASA GIBS 科学图层 (WMS)',

      // OpenPortGuide
      'opg.wind_stream': '风场流线 (Streamlines)',
      'opg.wind_barb': '风羽矢量 (Barbs)',
      'opg.gust': '阵风风速 (Gust)',
      'opg.surface_pressure': '地面气压 (Pressure)',
      'opg.air_temperature': '地表气温 (2m Temp)',
      'opg.precipitation': '降水强度 (Precipitation)',
      'opg.precipitation_shaded': '降水填色阴影图',
      'opg.significant_wave_height': '有效波高 (Wave Height)',
      'opg.primary_wave_height_direction': '主波向 (Wave Direction)',
      'opg.primary_wave_period': '主波周期 (Wave Period)',

      // Photos Panel
      'photos.title': '花卉照片 (iNaturalist)',
      'photos.enable': '开启图层',
      'photos.disable': '关闭图层',
      'photos.heatmap_mode': '热力图模式',
      'photos.date_range': '观测日期范围',
      'photos.to': '至',
      'photos.taxon': '物种类群',
      'photos.taxon_angio': '被子植物门（开花植物，默认）',
      'photos.taxon_all': '植物界（全部植物）',
      'photos.max_pages': '最大拉取页数',
      'photos.search_radius': '检索半径（公里，以选中点为中心）',

      // Vegetation Index Panel
      'veg.title': '植被指数 (NDVI/EVI) · 周边物种 · 入侵种预警',
      'veg.product': '遥感数据产品',
      'veg.opt_mod13q1': 'MOD13Q1 · MODIS Terra · 16日合成 (250m)',
      'veg.opt_vnp13a1': 'VNP13A1 · VIIRS SNPP · 16日合成 (500m)',
      'veg.query_btn': '查询最新合成指数',
      'veg.query_hint': '查询选中经纬度坐标点的最新可用 NDVI/EVI 遥感植被指数。',
      'veg.th_variable': '要素指标',
      'veg.th_value': '数值',
      'veg.th_note': '说明',
      'veg.composite_date': '影像合成时段',
      'veg.nearby_species': '周边物种分布 (iNaturalist)',
      'veg.load_species': '检索物种（按年份与半径）',
      'veg.filter_placeholder': '按中文名/学名搜索过滤…',
      'veg.plot_counts': '绘制月度观测频次图',
      'veg.show_map': '在地图上标注选定物种',
      'veg.clear_markers': '清除物种标注',
      'veg.counts_note': '频次基于选定经纬度周边所选年份的 iNaturalist 月度野外观测记录。',
      'veg.rain_label': '降水 · 干旱指数 · “超级花期”预警',
      'veg.load_power_365': '加载近 365 天逐天气象 (POWER)',
      'veg.aridity_init': '干旱指数: —',
      'veg.superbloom_init': '超级花期预测: — (降水基准)',
      'veg.pollinator_label': '传粉昆虫动态 (iNat 昆虫类群 ID，逗号分隔)',
      'veg.plot_pollinators': '绘制传粉者观测趋势',
      'veg.pollinator_hint': '默认类群：鳞翅目/蝴蝶与蛾 (47157)、蜜蜂总科 (630955)。可自定义编辑。',
      'veg.invasives_label': '外来入侵物种筛查（点位周边近 5 年自动统计）',
      'veg.btn_analyze_topn': '分析 Top-N 优势物种',
      'veg.btn_show_map': '地图标注',
      'veg.btn_clear': '清空',
      'veg.invasives_note': '统计坐标周边 5 年累计观测次数并排序，自动标记潜在的外来入侵植物风险。',
      'veg.th_rank': '排名',
      'veg.th_common_name': '俗名 / 中文通用名',
      'veg.th_scientific': '拉丁学名',
      'veg.th_5y_count': '5年观测频次',
      'veg.th_flag': '物种属性/预警',
      'veg.no_invasives': '未检索到明显外来入侵物种。',

      // Phenology Panel
      'pheno.title': '物候与花期预测模型',
      'pheno.curr_loc': '当前坐标点',
      'pheno.year_label': '预测基准年份 (POWER 逐日数据)',
      'pheno.compute_btn': '计算积温模型花期预测 (GDD)',
      'pheno.th_flower': '植物花卉名称',
      'pheno.th_base_temp': '生物学零度 (°C)',
      'pheno.th_gdd': '有效积温阈值 (°C·d)',
      'pheno.th_pred_date': '预测始花期',
      'pheno.th_days': '累计生长度日',
      'pheno.flower_custom': '自定义植物',
      'pheno.flower_cherry': '樱花',
      'pheno.flower_tulip': '郁金香',
      'pheno.flower_jasmine': '迎春花',
      'pheno.flower_plum': '梅花',
      'pheno.flower_peach': '桃花',
      'pheno.flower_rapeseed': '油菜花',
      'pheno.flower_wisteria': '紫藤',
      'pheno.flower_rose': '月季 / 玫瑰',
      'pheno.not_reached': '未达阈值',

      // Weather Panel
      'weather.title': '逐日气象要素 (NASA POWER)',
      'weather.query_date': '查询日期',
      'weather.query_btn': '查询气象数据',
      'weather.lag_note': 'NASA POWER 逐日气象数据通常滞后 1–2 天，建议查询昨天或前天的数据。',

      // Workflow Panel
      'workflow.title': 'GeoAI 智能分析工作流',
      'workflow.curr_center': '当前样带中心',
      'workflow.stage1_title': '多源数据接入',
      'workflow.stage1_desc': '高德底图、ORNL MODIS/VIIRS 植被合成数据、NASA POWER 气象、iNaturalist 生物观测。',
      'workflow.stage2_title': '空间采样定位',
      'workflow.stage2_desc': '地图标注经纬度锚点配合半径定义样带缓冲区空间采样。',
      'workflow.stage3_title': '遥感特征抽取',
      'workflow.stage3_desc': 'NDVI/EVI 时序演化、样带近邻均值、长势趋势与质量标识时相分析。',
      'workflow.stage4_title': 'AI / ML 模型推断',
      'workflow.stage4_desc': 'GDD 积温物候模型、季节趋势启发式、Qwen 兼容智能体及未来预测特征。',
      'workflow.stage5_title': '可视化多维研判',
      'workflow.stage5_desc': '样带多维时序图、健康/反常风险标签、盛花窗口期与时空证据报告。',
      'workflow.meta_spatial': '时空渲染引擎',
      'workflow.meta_rs': '遥感数据谱系',
      'workflow.meta_climate': '气象驱动数据',
      'workflow.meta_deploy': '模型部署运行',
      'workflow.meta_ready': '已适配 ModelScope Space',
      'workflow.action_title': '执行 GeoAI 完整工作流',
      'workflow.action_desc': '使用当前地图中心锚点与设定半径执行全链条推演：空间样带 → 遥感要素抽取 → POWER 物候模型 → 健康/风险/花期研判。',
      'workflow.radius_label': '样带辐射半径 (km)',
      'workflow.product_label': '植被指数卫星源',
      'workflow.history_label': '回溯历史年限 (年)',
      'workflow.run_btn': '一键执行全链条分析',
      'workflow.center_btn': '使用当前地图中心',
      'workflow.status_ready': '就绪。选择地图坐标点或使用当前中心，即可一键运行工作流。',
      'workflow.res_health': '植被长势健康度',
      'workflow.res_risk': '物候胁迫与反常风险',
      'workflow.res_window': '预测盛花窗口期',
      'workflow.res_hint': '运行工作流以生成基于多源时空数据证据的斑块综合研判。',

      // Patch Analysis Panel
      'patch.title': 'GeoAI 样带斑块分析',
      'patch.loc_label': '采样坐标',
      'patch.radius_label': '斑块半径 (km)',
      'patch.product_label': '植被数据产品',
      'patch.history_label': '历史回溯年限 (年)',
      'patch.run_btn': '运行斑块分析',
      'patch.center_btn': '使用当前地图中心',
      'patch.res_health': '植被长势健康度',
      'patch.res_risk': '物候异常风险',
      'patch.res_window': '花期窗口',
      'patch.hint': '运行分析以生成斑块级生态物候研判。',

      // AI Assistant Panel
      'ai.title': 'AI 助手',
      'ai.btn_what_to_plant': '智能研判：此处适宜种植什么？',
      'ai.btn_ask_followup': '向智能体提问 / 追问',
      'ai.placeholder': '请输入您想了解的植物生态或气象问题…',

      // Plant ID Panel
      'plantid.title': '植物图像识别与保育',
      'plantid.desc': '上传花卉或植物照片，通过服务端 Qwen-VL 多模态视觉大模型推断物种名称与濒危保护等级。科研场景建议结合植物志或专家意见二次复核。',
      'plantid.provider_label': '视觉识别模型',
      'plantid.provider_opt': 'Qwen-VL 兼容多模态视觉模型',
      'plantid.region_hint_label': '地域 / 生境线索提示（可选）',
      'plantid.region_hint_placeholder': '例如：中国华东、高山草甸、湿地、城市公园…',
      'plantid.organ_label': '拍摄器官部位',
      'plantid.organ_auto': '自动识别',
      'plantid.organ_flower': '花朵',
      'plantid.organ_leaf': '叶片',
      'plantid.organ_fruit': '果实',
      'plantid.organ_bark': '树皮 / 枝干',
      'plantid.image_label': '上传图片',
      'plantid.identify_btn': '开始智能识别',
      'plantid.export_btn': '导出识别结果 (JSON)',

      // Forecast Panel
      'forecast.title': 'NDVI/EVI 遥感时序预测 (未来30天)',
      'forecast.product_label': '卫星产品',
      'forecast.target_index': '预测目标指数',
      'forecast.opt_ndvi': 'NDVI (归一化植被指数)',
      'forecast.opt_evi': 'EVI (增强植被指数)',
      'forecast.history_len': '历史训练年限 (年)',
      'forecast.pull_note': '系统将提取历年 16 天合成遥感指数，并与 NASA POWER 逐日气象特征对齐构建时序特征工程。',
      'forecast.train_opts': '模型训练超参数',
      'forecast.epochs': '训练轮数 (Epochs)',
      'forecast.lr': '学习率 (LR)',
      'forecast.tfjs_note': '若本地 TensorFlow.js 环境未就绪，系统将自适应退避至多元线性回归基线模型。',
      'forecast.btn_train': '训练模型并生成预测',
      'forecast.btn_clear': '清空图表',
      'forecast.inputs_desc': '输入要素：MODIS/VIIRS 历史植被绿度时序 + POWER 逐日气温与降水；特征工程包含多阶滞后算子与周期正弦正交编码。',

      // Common
      'common.analyzing': '正在分析中…',
      'common.analyze_failed': '分析失败，请重试。',
      'common.loading': '加载中...',
      'common.error': '异常错误',
      'common.date': '日期',
      'common.close': '关闭'
  ...
  applyToDOM() {
    ...
    document.querySelectorAll('[data-i18n]').forEach(el => {
      ...
      if (val !== undefined) {
        el.textContent = val;
        // User requirement: In Chinese version, delete the base map hint completely
        if (key === 'layers.base_map_hint') {
          el.style.display = (this.currentLang === 'zh' || !val) ? 'none' : '';
        }
      }
    });
